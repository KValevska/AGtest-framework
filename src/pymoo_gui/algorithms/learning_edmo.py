# ------------------------------------------------------------------------------------
# Module: learning_edmo.py
# Summary: cross-problem memory EDMO class, factory and GUI registry definition.
# Implementation: elite patterns are cached between compatible runs and reused as warm-start and guided samples.
# Responsibility: adds an article-inspired learning-across-problems evolutionary dynamic MOEA.
