# ------------------------------------------------------------------------------------
# Module: rnn_guided_dmo.py
# Summary: lightweight recurrent-guided DMO class, factory and GUI registry definition.
# Implementation: a small deterministic recurrent state predicts motion of elite centroids and guides new samples.
# Responsibility: adds an RNN-guided dynamic MOEA variant without external deep-learning dependencies.
