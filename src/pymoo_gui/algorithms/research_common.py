# Shared utilities and GUI-compatible base classes for custom research MOEAs.

# ------------------------------------------------------------------------------------
# Module: research_common.py
# Summary: validation helpers, NumPy-based multiobjective operators and a GUI runtime adapter.
# Implementation: custom research algorithms reuse one deterministic optimization loop and shared survival logic.
# Responsibility: supports article-based MOEA variants not provided directly by pymoo or Platypus.
